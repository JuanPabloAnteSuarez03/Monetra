...
export const Registro = () => {
  ...
  const openCamera = async (mode = facingMode) => {
    ...
    if (!navigator.mediaDevices?.getUserMedia) {
      setCameraError(
        "Este navegador no permite acceder a la cámara. Prueba subir una foto en su lugar.",
      );
    ...
    canvas.toBlob(
      async (blob) => {
        ...
        if (success) {
          ...
          setCameraError(
            ocrErrorRef.current ||
              "No se pudo extraer información. Intenta de nuevo.",
          );
          setCameraPhase("error");
        }
      },
        ...
        <div className="cam-overlay">
          <div className="cam-modal">
            ...
            <div className="cam-video-wrap">
              ...
              {cameraPhase === "live" && (
                <div
                  className={`cam-guide${isStable ? " cam-guide--stable" : ""}`}
                >
              ...
              {cameraPhase === "error" && (
                <div className="cam-processing-overlay">
                  ...
                  <button className="cam-retry-btn" onClick={retryCamera}>
                    Reintentar
                  </button>
                </div>
              )}
              ...
              {cameraPhase === "live" ? (
                <>
                  <p className="cam-hint">
                    {isStable
                      ? "Capturando..."
                      : "Encuadra la factura y mantén el teléfono firme"}
                  </p>
                  <button
